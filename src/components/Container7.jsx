...
const Container7 = memo(({ className = "" }) => {
  return (
    <div
    ...
    >
      <div className="absolute top-[0px] left-[0px] shadow-[4px_4px_0px_1px_#1e1e1e] rounded-3xs bg-absolute-white box-border w-[100px] overflow-hidden flex flex-row items-center justify-center py-[7px] px-[22px] border-[2px] border-solid border-grey-15">
        <div className="relative leading-[130%] font-extrabold inline-block min-w-[52px] mq450:text-7xl mq450:leading-[34px] mq800:text-16xl mq800:leading-[46px]">
          05
        </div>
      </div>
      <div className="absolute top-[65px] left-[40px] rounded-[50%] bg-absolute-white box-border w-6 h-6 border-[0px] border-solid border-grey-15" />
      <div className="absolute top-[85px] left-[44px] bg-orange-80 h-[43px] flex flex-row items-center justify-center py-0 px-1 box-border">
