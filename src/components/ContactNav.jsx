...
const ContactNav = memo(({ className = "" }) => {
  return (
    <div
    ...
    >
      <header className="self-stretch h-36 flex flex-col items-start justify-start pt-[78px] px-0 pb-0 box-border max-w-full text-left text-base text-grey-15 font-outfit mq1050:h-auto">
        <FrameComponent
          abstractDesign="/abstract-design1.svg"
          abstractDesign1="/abstract-design-11.svg"
        />
      ...
      <div className="self-stretch h-12 rounded-md bg-orange-90 box-border overflow-hidden shrink-0 flex flex-row items-end justify-start py-0 pr-0 pl-[1159px] gap-[988px] mt-[-128px] border-[2px] border-solid border-grey-15 lg:gap-[494px] lg:pl-[579px] lg:box-border mq750:gap-[247px] mq750:pl-[289px] mq750:box-border mq450:gap-[123px] mq450:pl-5 mq450:box-border">
        <img
          className="ml-[-1168px] mb-[-45px] h-[180px] w-[180px] relative object-contain shrink-0"
          alt=""
          src="/abstract-design-22@2x.png"
        />
        <img
          className="mb-[-45px] h-[180px] w-[180px] relative object-contain shrink-0"
          alt=""
          src="/abstract-design-32@2x.png"
        />
      </div>
    </div>
  );
