import HomeHeroAndNav from "../components/HomeHeroAndNav";
...
const HomePageLaptop = () => {
  return (
    <div className="w-full relative bg-orange-97 overflow-hidden flex flex-col items-end justify-start pt-0 px-[50px] pb-10 box-border gap-[150px] leading-[normal] tracking-[normal] mq450:gap-[37px] mq750:gap-[75px] mq750:pl-[25px] mq750:pr-[25px] mq750:box-border">
      <HomeHeroAndNav />
      <OurBenifits />
      <HomeTestimonials />
      <HomeFAQ />
