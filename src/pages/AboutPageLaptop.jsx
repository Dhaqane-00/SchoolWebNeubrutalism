...
import AboutOurAchie from "../components/AboutOurAchie";
...
const AboutPageLaptop = () => {
  return (
    <div className="w-full relative bg-orange-97 overflow-hidden flex flex-col items-end justify-start pt-4 px-[50px] pb-10 box-border gap-[150px] leading-[normal] tracking-[normal] mq800:gap-[75px] mq800:pl-[25px] mq800:pr-[25px] mq800:box-border mq450:gap-[37px]">
      <AboutHeroAndNav
        frameHeaderPadding="unset"
        abstractDesign="/abstract-design@2x.png"
        abstractDesign1="/abstract-design-1@2x.png"
        abstractDesign2="/abstract-design-21.svg"
        abstractDesign3="/abstract-design-31.svg"
        textButton="/text-button.svg"
        buttonDisplay="inline-block"
        buttonMinWidth="43px"
        textButtonBackgroundColor="#ffefe6"
        buttonDisplay1="inline-block"
        buttonMinWidth1="65px"
        textButtonBackgroundColor1="unset"
        buttonDisplay2="inline-block"
        buttonMinWidth2="78px"
        textButtonBackgroundColor2="unset"
        buttonDisplay3="inline-block"
        buttonMinWidth3="80px"
        buttonDisplay4="inline-block"
        buttonMinWidth4="87px"
        frameDivDisplay="inline-block"
        frameDivMinWidth="58px"
        abstractDesignIconMinHeight="348px"
        abstractDesign4="/abstract-design-4.svg"
        textWidth="100px"
        text="Overview"
        headingDisplay="inline-block"
        headingMinWidth="68px"
        heading="Welcome to Little Learners Academy"
        paragraphHeight="unset"
        paragraphDisplay="unset"
      ...
      <AboutOurAchie
        ...
        paragraph="Presented by the National Association for the Education of Young Children (NAEYC) in recognition of Little Learners Academy's commitment to delivering exceptional early childhood education and fostering a nurturing learning environment."
        paragraph="Awarded by the Education Excellence Association for our pioneering efforts in introducing innovative STEAM (Science, Technology, Engineering, Arts, and Mathematics) programs that ignite creativity and critical thinking in young learners."
      />
      <OurHistory />
      <AboutTeacher />
...
export default AboutPageLaptop;
